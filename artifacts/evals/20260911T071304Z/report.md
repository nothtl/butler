# Evaluation report — 20260911T071304Z

tier: regression · model: deepseek-chat · prompt: v3-q3 · commit: fc43007
cases: 59 · runtime: 81.2s · estimate: {"calls": 65, "input_tokens": 49400, "output_tokens": 5590, "total_tokens": 54990, "cost_usd": 0.0195, "runtime_s": 78.0}

## Metrics (with 95% Wilson CI)

| Component | Score | n | 95% CI |
|---|---|---|---|
| task_success | 79.7% | 59 | 68–88% |
| intent_accuracy | 79.7% | 59 | 68–88% |
| clarification_quality | 100.0% | 13 | 77–100% |
| followup_accuracy | 83.3% | 6 | 44–97% |
| tool_selection | 79.7% | 59 | 68–88% |
| temporal_accuracy | 100.0% | 10 | 72–100% |

**Behavioral score:** 83.1%
...
- [WRONG_INTENT] 'This topic is for my basketball club.' -> update_item
- [WRONG_INTENT] '' -> None
- [WRONG_INTENT] '' -> None
- [WRONG_INTENT] '' -> None
- [WRONG_INTENT] '' -> None
- [WRONG_INTENT] 'tomorrow morning' -> plan_day
- [WRONG_INTENT] 'before my meeting' -> status
